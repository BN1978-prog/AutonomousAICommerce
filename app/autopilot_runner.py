...
run_step("sku_master_enricher","python -m app.sku_master_enricher")
run_step("cj_product_discovery_importer","python -m app.cj_product_discovery_importer")
run_step("sku_cj_mapper","python -m app.sku_cj_mapper")
run_step("product_scoring_engine","python -m app.product_scoring_engine")
run_step("seo_content_engine","python -m app.seo_content_engine")
run_step("universal_listing_builder","python -m app.universal_listing_builder")
run_step("marketplace_listing_optimizer","python -m app.marketplace_listing_optimizer")
run_step("universal_publisher","python -m app.universal_publisher")
